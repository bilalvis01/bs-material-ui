type classes = {.
  ...
  "absolute": Js.undefined(string),
  "inset": Js.undefined(string),
  "light": Js.undefined(string),
  "middle": Js.undefined(string),
...
external makeProps: (
  ...
  ~variant: [@bs.string] [ | `fullwidth | `inset | `middle ]=?,
  /* Dom props */
  ~key: string=?,
