...
type props = {
  ...
  "alignContent": Js.undefined(string),
  "alignItems": Js.undefined(string),
  "classes": Js.undefined(classes),
  "component": Js.undefined(string),
  "container": Js.undefined(bool),
  "direction": Js.undefined(string),
  "item": Js.undefined(bool),
  "justify": Js.undefined(string),
  "lg": Js.undefined(gridSize),
  "md": Js.undefined(gridSize),
  "sm": Js.undefined(gridSize),
  "spacing": Js.undefined(int),
  "wrap": Js.undefined(string),
  "xl": Js.undefined(gridSize),
  "xs": Js.undefined(gridSize),
  "zeroMinWidth": Js.undefined(bool),
  /* Dom props */
