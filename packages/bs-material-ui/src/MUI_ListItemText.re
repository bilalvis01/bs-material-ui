type classes = {
  ...
  "inset": Js.undefined(string),
  "primary": Js.undefined(string),
  "secondary": Js.undefined(string),
};
...
type props = {
  ...
  "disableTypography": Js.undefined(bool),
  "inset": Js.undefined(bool),
  "primary": Js.undefined(React.element),
  "primaryTypographyProps": Js.undefined(MUI_Typography.props),
  "secondary": Js.undefined(React.element),
  "secondaryTypograhyProps": Js.undefined(MUI_Typography.props),
  /* Dom props */
