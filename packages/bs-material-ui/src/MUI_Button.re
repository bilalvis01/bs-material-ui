type classes = {.
  ...
  "textPrimary": Js.undefined(string),
  "textSecondary": Js.undefined(string),
  "outlined": Js.undefined(string),
  "outlinedPrimary": Js.undefined(string),
  "outlinedSecondary": Js.undefined(string),
  "contained": Js.undefined(string),
  "containedPrimary": Js.undefined(string),
  "containedSecondary": Js.undefined(string),
  "focusVisible": Js.undefined(string),
  "disabled": Js.undefined(string),
  "colorInherit": Js.undefined(string),
  "textSizeSmall": Js.undefined(string),
  "textSizeLarge": Js.undefined(string),
  "outlinedSizeSmall": Js.undefined(string),
  "outlinedSizeLarge": Js.undefined(string),
  "containedSizeSmall": Js.undefined(string),
  "containedSizeLarge": Js.undefined(string),
  "sizeSmall": Js.undefined(string),
  "sizeLarge": Js.undefined(string),
  "fullWidth": Js.undefined(string),
  "startIcon": Js.undefined(string),
  "endIcon": Js.undefined(string),
  "iconSizeSmall": Js.undefined(string),
  "iconSizeMedium": Js.undefined(string),
  "iconSizeLarge": Js.undefined(string),
};
...
type props = {.
  ...
  "endIcon": Js.undefined(React.element),
  "fullWidth": Js.undefined(bool),
  "href": Js.undefined(string),
  "size": Js.undefined(string),
  "startIcon": Js.undefined(React.element),
...
type makeClasses = {
  ...
  [@bs.optional] textPrimary: string,
  [@bs.optional] textSecondary: string,
  [@bs.optional] outlined: string,
  [@bs.optional] outlinedPrimary: string,
  [@bs.optional] outlinedSecondary: string,
  [@bs.optional] contained: string,
  [@bs.optional] containedPrimary: string,
  [@bs.optional] containedSecondary: string,
  [@bs.optional] focusVisible: string,
  [@bs.optional] disabled: string,
  [@bs.optional] colorInherit: string,
  [@bs.optional] textSizeSmall: string,
  [@bs.optional] textSizeLarge: string,
  [@bs.optional] outlinedSizeSmall: string,
  [@bs.optional] outlinedSizeLarge: string,
  [@bs.optional] containedSizeSmall: string,
  [@bs.optional] containedSizeLarge: string,
  [@bs.optional] sizeSmall: string,
  [@bs.optional] sizeLarge: string,
  [@bs.optional] fullWidth: string,
  [@bs.optional] startIcon: string,
  [@bs.optional] endIcon: string,
  [@bs.optional] iconSizeSmall: string,
...
type makeProps = {
  ...
  /*
  [@bs.optional] 
  muiTouchRippleProps: MUI_TouchRipple.props,
  */
  ...
  onWaiting: ReactEvent.Media.t => unit,
  /* Image events */
  [@bs.optional]onLoad: ReactEvent.Image.t => unit /* duplicate */, /*[@bs.optional] onError: ReactEvent.Image.t => unit,*/
  /* Animation events */
  [@bs.optional]
  onAnimationStart: ReactEvent.Animation.t => unit,
  [@bs.optional]
