...
type classes = {.
  ...
  "checked": Js.undefined(string),
  "disabled": Js.undefined(string),
  "indeterminate": Js.undefined(string),
...
type props = {.
  /* Checkbox props */
  "childen": Js.undefined(React.element),
  "checked": Js.undefined(bool),
  "checkedIcon": Js.undefined(React.element),
  "classes": Js.undefined(classes),
  "color": Js.undefined(string),
  "disabled": Js.undefined(bool),
  "disableRipple": Js.undefined(bool),
  "icon": Js.undefined(React.element),
  "id": Js.undefined(string),
  "indeterminate": Js.undefined(bool),
  "indeterminateIcon": Js.undefined(bool),
...
external makeProps: (
  ...
  ~classes: classes=?,
  ~color: [@bs.string] [ | `primary | `secondary | `default ]=?,
  ~disabled: bool=?,
  ~disableRipple: bool=?,
  ~icon: React.element=?,
  ~id: string=?,
