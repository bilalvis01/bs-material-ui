type classes = {
  ...
  "container": Js.undefined(string),
  "focusVisible": Js.undefined(string),
  "dense": Js.undefined(string),
  "alignItemsFlexStart": Js.undefined(string),
  "disabled": Js.undefined(string),
  "divider": Js.undefined(string),
  "gutters": Js.undefined(string),
  "button": Js.undefined(string),
  "secondaryAction": Js.undefined(string),
  "selected": Js.undefined(string),
};
...
type props = {
  ...
  "alignItems": Js.undefined(string),
  "autoFocus": Js.undefined(bool),
  "button": Js.undefined(bool),
  "classes": Js.undefined(classes),
  "component": Js.undefined(string),
  "_ContainerComponent": Js.undefined(string),
  "_ContainerProps": Js.undefined(MUI_Container.props),
  "dense": Js.undefined(bool),
  "disabled": Js.undefined(bool),
  "disableGutters": Js.undefined(bool),
  "divider": Js.undefined(bool),
...
type makeProps = {
  ...
  async: bool,
  [@bs.optional]
  autoComplete: string, /* has a fixed, but large-ish, set of possible values */  [@bs.optional]
  autoPlay: bool,
  [@bs.optional]
  challenge: string,
  [@bs.optional]
