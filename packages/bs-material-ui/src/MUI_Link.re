type classes = {
  ...
  "underlineNone": Js.undefined(string),
  "underlineHover": Js.undefined(string),
  "underlineAlways": Js.undefined(string),
...
type props = {
  ...
  "_TypographyClasses": Js.undefined(MUI_Typography.classes),
  "underline": Js.undefined(string),
  "variant": Js.undefined(string),
  /* Typography props */
  "align": Js.undefined(string),
  "display": Js.undefined(string),
  "gutterBottom": Js.undefined(bool),
  "noWrap": Js.undefined(bool),
  "paragraph": Js.undefined(bool),
  "variantMapping": Js.undefined(MUI_Typography.variantMapping),
  /* Dom props */
...
type makeProps = {
  ...
  muiTypographyClasses: MUI_Typography.classes,
  [@bs.optional] 
  underline: string,
  [@bs.optional] 
  variant: string,
