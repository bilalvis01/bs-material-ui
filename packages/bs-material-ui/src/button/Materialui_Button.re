...
type makeProps = {
  ...
  [@bs.optional]
  classes: MaterialuiPropsTypes_Classes_Button.t,
  [@bs.optional]
  color: MaterialuiPropsTypes_Color_Button.t,
  [@bs.optional]
  ...
  href: string,
  [@bs.optional]
  size: MaterialuiPropsTypes_Size_Button.t,
  [@bs.optional]
  startIcon: React.element,
  [@bs.optional]
  variant: MaterialuiPropsTypes_Variant_Button.t,
  /* ButtonBase props */
  [@bs.optional]
  ...
  /*
  ~_TouchRippleProps: Materialui_TouchRipple.props=?,
  */
