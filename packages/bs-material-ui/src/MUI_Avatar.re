...
type props = {.
  ...
  "imgProps": Js.undefined(ReactDOMRe.domProps),
  "sizes": Js.undefined(string),
  "src": Js.undefined(string),
...
type makeClasses = {
  ...
  [@bs.optional] colorDefault: string,
  [@bs.optional] img: string,
};
