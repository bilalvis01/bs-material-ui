type classes = {
  ...
  "labelPlacementStart": Js.undefined(string),
  "labelPlacementTop": Js.undefined(string),
  "labelPlacementBottom": Js.undefined(string),
...
type props = {
  ...
  "control": Js.undefined(React.element),
  "disabled": Js.undefined(bool),
  "inputRef": Js.undefined(ReactDOMRe.domRef),
  "label": Js.undefined(React.element),
  "labelPlacement": Js.undefined(string),
...
type makeClasses = {
  ...
  [@bs.optional] labelPlacementStart: string,
  [@bs.optional] labelPlacementTop: string,
  [@bs.optional] labelPlacementBottom: string,
