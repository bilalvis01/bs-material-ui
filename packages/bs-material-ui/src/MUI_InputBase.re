type classes = {
  ...
  "formControl": Js.undefined(string),
  "focused": Js.undefined(string),
  "disabled": Js.undefined(string),
  "adornedStart": Js.undefined(string),
  "adornedEnd": Js.undefined(string),
  "error": Js.undefined(string),
  "marginDense": Js.undefined(string),
  "multiline": Js.undefined(string),
  "fullWidth": Js.undefined(string),
  "input": Js.undefined(string),
  "inputMarginDense": Js.undefined(string),
  "inputSelect": Js.undefined(string),
  "inputMultiline": Js.undefined(string),
  "inputTypeSearch": Js.undefined(string),
  "inputAdornedStart": Js.undefined(string),
  "inputAdornedEnd": Js.undefined(string),
  "inputHiddenLabel": Js.undefined(string),
};
...
type props = {
  .
  /* InputBase props */
  "autoComplete": Js.undefined(string),
  ...
  "disableUnderline": Js.undefined(bool),
  "endAdornment": Js.undefined(React.element),
  "error": Js.undefined(bool),
  "fullWidth": Js.undefined(bool),
  "id": Js.undefined(string),
  "inputComponent": Js.undefined(string),
  "inputProps": Js.undefined(ReactDOMRe.domProps),
  "inputRef": Js.undefined(ReactDOMRe.domRef),
  "margin": Js.undefined(string),
  "multiline": Js.undefined(bool),
  ...
  "rows": Js.undefined(int), // string|number
  "rowsMax": Js.undefined(int), // string|number
  "startAdornment": Js.undefined(React.element),
  "_type": Js.undefined(string),
  "value": Js.undefined(string),
  "select": Js.undefined(bool),
  /* Dom props */
