type classes = {.
  ...
  "badge": Js.undefined(string),
  "colorPrimary": Js.undefined(string),
  "colorSecondary": Js.undefined(string),
  "colorError": Js.undefined(string),
  "dot": Js.undefined(string),
  "anchorOriginTopRightRectangle": Js.undefined(string),
  "anchorOriginBottomRightRectangle": Js.undefined(string),
  "anchorOriginTopLeftRectangle": Js.undefined(string),
  "anchorOriginBottomLeftRectangle": Js.undefined(string),
  "anchorOriginTopRightCircle": Js.undefined(string),
  "anchorOriginBottomRightCircle": Js.undefined(string),
  "anchorOriginTopLeftCircle": Js.undefined(string),
  "anchorOriginBottomLeftCircle": Js.undefined(string),
  "invisible": Js.undefined(string),
};
...
type anchorOrigin = {.
  "horizontal": Js.undefined(string),
  "vertical": Js.undefined(string),
};

[@bs.obj]
external anchorOrigin: (
  ~horizontal: [@bs.string] [ | `left | `right ]=?,
  ~vertical: [@bs.string] [ | `bottom | `top ]=?,
  unit
) => anchorOrigin = "";
...
type props = {.
  ...
  "anchorOrigin": Js.undefined(anchorOrigin),
  "badgeContent": Js.undefined(React.element),
  "classes": Js.undefined(classes),
  "color": Js.undefined(string),
  "component": Js.undefined(string),
  "invisible": Js.undefined(bool),
  "max": Js.undefined(int),
  "overlap": Js.undefined(string),
  "showZero": Js.undefined(bool),
...
type makeClasses = {
  ...
  [@bs.optional] dot: string,
  [@bs.optional] anchorOriginTopRightRectangle: string,
  [@bs.optional] anchorOriginBottomRightRectangle: string,
  [@bs.optional] anchorOriginTopLeftRectangle: string,
  [@bs.optional] anchorOriginBottomLeftRectangle: string,
  [@bs.optional] anchorOriginTopRightCircle: string,
  [@bs.optional] anchorOriginBottomRightCircle: string,
  [@bs.optional] anchorOriginTopLeftCircle: string,
