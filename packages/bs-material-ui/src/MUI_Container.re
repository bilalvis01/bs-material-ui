type classes = {.
  ...
  "fixed": Js.undefined(string),
  "maxWidthXs": Js.undefined(string),
  "maxWidthSm": Js.undefined(string),
  "maxWidthMd": Js.undefined(string),
  "maxWidthLg": Js.undefined(string),
  "maxWidthXl": Js.undefined(string),
};
...
type props = {.
  ...
  "fixed": Js.undefined(bool),
  "maxWidth": Js.undefined(maxWidth),
  /* Dom props */
...
type makeClasses = {
  ...
  [@bs.optional] maxWidthSm: string,
  [@bs.optional] maxWidthMd: string,
