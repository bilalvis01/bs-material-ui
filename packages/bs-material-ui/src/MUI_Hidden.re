type props = {
  ...
  "implementation": Js.undefined(string),
  "initialWidth": Js.undefined(string),
  "lgDown": Js.undefined(bool),
  "lgUp": Js.undefined(bool),
  "mdDown": Js.undefined(bool),
  "mdUp": Js.undefined(bool),
  "only": Js.undefined(array(string)),
  "smDown": Js.undefined(bool),
  "smUp": Js.undefined(bool),
  "xlDown": Js.undefined(bool),
  "xlUp": Js.undefined(bool),
  "xsDown": Js.undefined(bool),
  "xsUp": Js.undefined(bool),
  /* Dom props */
...
external makeProps: (
  ...
  ~implementation: [@bs.string] [ | `js | `css ]=?,
  ~initialWidth: [@bs.string] [ | `xs | `sm | `md | `lg | `xl ]=?,
  ~lgDown: bool=?,
  ~lgUp: bool=?,
  ~mdDown: bool=?,
  ~mdUp: bool=?,
