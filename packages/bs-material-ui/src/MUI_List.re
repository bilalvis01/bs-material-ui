type classes = {
  ...
  "padding": Js.undefined(string),
  "dense": Js.undefined(string),
  "subheader": Js.undefined(string),
};
...
type props = {
  ...
  "components": Js.undefined(string),
  "dense": Js.undefined(bool),
  "disablePadding": Js.undefined(bool),
  "subheader": Js.undefined(React.element),
  /* Dom props */
