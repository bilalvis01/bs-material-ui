...
type makeProps = {
  ...
  [@bs.optional]
  classes: MaterialuiPropsTypes_Classes_Menu.t,
  [@bs.optional]
  disableAutoFocusItem: bool,
  // ~_MenuListProps: Materialui_MenuList.props=?,
  [@bs.optional]
  onClose: MaterialuiPropsTypes_OnCloseModal.t,
  [@bs.optional]
  ...
  muiPopoverClasses: MaterialuiPropsTypes_Classes_Popover.t,
  [@bs.optional]
  transitionDuration: MaterialuiPropsTypes_TransitionDuration_Menu.t,
  [@bs.optional]
  variant: MaterialuiPropsTypes_Variant_Menu.t,
  /* Popover props */
  [@bs.optional]
  action: ReactDOMRe.domRef,
  [@bs.optional]
  anchorOrigin: MaterialuiPropsTypes_AnchorOrigin_Popover.t,
  [@bs.optional]
  anchorPosition: MaterialuiPropsTypes_AnchorPosition_Popover.t,
  [@bs.optional]
  anchorReference: MaterialuiPropsTypes_AnchorReference_Popover.t,
  [@bs.optional]
  container: unit => React.element,
  [@bs.optional]
  elevation: MaterialuiPropsTypes_Elevation.t,
  [@bs.optional]
  getContentAnchorEl: Dom.element => Dom.element,
  [@bs.optional]
  marginThreshold: int,
  [@bs.optional] [@bs.as "PaperProps"]
  muiPaperProps: Materialui_Paper.props,
  [@bs.optional]
  transformOrigin: MaterialuiPropsTypes_TransformOrigin_Popover.t,
  [@bs.optional] [@bs.as "TransitionComponent"]
  muiTransitionComponent: MaterialuiPropsTypes_Component.t,
  [@bs.optional] [@bs.as "TransitionProps"]
  muiTransitionProps: MaterialuiPropsTypes_Props.t,
  /* Modal props */
  [@bs.optional] [@bs.as "BackdropComponent"]
  muiBackdropComponent: MaterialuiPropsTypes_Component.t,
  [@bs.optional] [@bs.as "BackdropProps"]
  muiBackdropProps: Materialui_Backdrop.props,
  [@bs.optional]
